...
It is based on [bitwalker's](https://github.com/bitwalker) `alpine-erlang` image, and installs Elixir (1.6.5), Node.js (6.10.x), Hex and Rebar. It can handle compiling
...
```
$ docker run --rm -it --user=1000001 littlekidogo/alpine-elixir-phoenix iex
...
```dockerfile
FROM littlekidogo/alpine-elixir-phoenix:latest
